...
Noeud* Interpreteur::seqInst() {
  ...
  } while (m_lecteur.getSymbole() == "<VARIABLE>" || m_lecteur.getSymbole() == "si" || m_lecteur.getSymbole() == "tantque" || m_lecteur.getSymbole() == "siRiche" || m_lecteur.getSymbole() == "repeter"
...
// <instEcrire> ::= ecrire ( <expression> | <chaine> { , <expression> | <chaine> } )
    ...
    testerEtAvancer("(");
    //TODO Noeud* = new NoeudInstEcrire();
    Noeud* contenu = nullptr;
    if(m_lecteur.getSymbole() == "<CHAINE>") {
        contenu = m_table.chercheAjoute(m_lecteur.getSymbole());
        m_lecteur.avancer();
    } else {
        contenu = expression();
    }
    //TODO n->ajoute(contenu)
